 ...
 *
 * @package GutenCore
 * @since GutenCore 1.1.0
 */

if ( ! class_exists( 'gutencore_Protocol_Relative_Theme_Assets' ) ) :
	class gutencore_Protocol_Relative_Theme_Assets {
		/**
	...
	$gutencore_protocol_relative_theme_assets = new gutencore_Protocol_Relative_Theme_Assets;
endif;
